	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				...
				<div class="card-tools">
					<a class="btn btn-sm btn-success" href="./index.php?page=new_project"><i class="fa fa-plus"></i> Add project</a>
				</div>
				<?php endif; ?>
			</div>
		</div>
...
<script>
	...
	$('.new_productivity').click(function(){
		uni_modal("New Progress for "+$(this).attr('data-task'),"manage_progress.php?pid="+$(this).attr('data-pid')+"&tid="+$(this).attr('data-tid'),'large')
	})
	})
