		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-success bg-success btn-sm" type="button" id="new_task"><i class="fa fa-plus"></i> Add Task</button>
					</div>
				<?php endif; ?>
				</div>
							...
							?>
								<tr>
			                        ...
			                        <td class="text-center">
										<button type="button" class="btn btn-sm border-dark wave-effect text-dark dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
					                      Action
					                    </button>
		...
		<div class="col-md-12">
			<div class="card card-outline card-primary">
				<div class="card-header">
					...
					<div class="card-tools">
						<button class="btn btn-success bg-success btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> Add Productivity</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
